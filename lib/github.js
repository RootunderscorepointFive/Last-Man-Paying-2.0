...
// Read any repo JSON file fresh (the sync bot commits with [skip ci], so bundled
// copies can be stale — fetch live for anything user-facing like email content).
...
module.exports = { getData, getFile, commitData, mutateData };
